...
namespace Monster_Train_2_Relics_Reloaded.Plugin
{
    ...
    public class Plugin : BaseUnityPlugin
    {
        ...
        public void Awake()
        {
            ...
            addConcussiveCoals = Config.Bind("General", "ConcussiveCoals", true, "Enable Concussive Coals. (50% chance to apply Dazed when an enemy unit enters your train.)");
            ...
            addLightsGift = Config.Bind("General", "LightsGift", true, "Enable Light's Gift. (Apply Dazed to enemy units when they enter the floor below the Pyre Room.)");
            ...
            addVaporFunnel = Config.Bind("General", "VaporFunnel", true, "Enable Vapor Funnel. (Apply Dazed to enemy units when they enter the Pyre Room. Your Pyre gets -5Attack.)");
